...
export default function TeamManagement() {
  ...
  useEffect(() => {
    ...
    async function loadAssignedRequests() {
      ...
      try {
        ...
        if (!canceled) setError(err.message || "Erro ao carregar as requisicoes atribuidas.");
      } finally {
  ...
  const filterControls = [
    { id: "status", label: "Status", value: statusFilter, options: STATUS_OPTIONS, onChange: (e) => setStatusFilter(e.target.value) },
    { id: "date", label: "Data", value: dateOrder, options: DATE_ORDER_OPTIONS, onChange: (e) => setDateOrder(e.target.value) },
    { id: "workforce", label: "MdO", value: workforceOrder, options: WORKFORCE_ORDER_OPTIONS, onChange: (e) => setWorkforceOrder(e.target.value) },
  ];
