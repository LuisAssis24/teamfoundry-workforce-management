        ...
        <div className="p-4 md:p-6 space-y-4">
          ...
          {loading ? (
            <div className="animate-pulse space-y-3">
              <div className="h-14 bg-base-200 rounded-lg" />
              <div className="h-14 bg-base-200 rounded-lg" />
            </div>
          ) : educations.length === 0 ? (
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            ...
            <div
              className={`border border-dashed rounded-xl p-6 text-center cursor-pointer bg-base-50 ${errors.file ? "border-error" : "border-base-300"}`}
              onDragOver={prevent}
              onDragEnter={prevent}
              onDrop={handleDrop}
