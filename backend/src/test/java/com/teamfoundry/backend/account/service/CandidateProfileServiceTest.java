...
class CandidateProfileServiceTest {
    ...
    void setUp() {
        ...
        sampleAccount.setEmail("candidate@example.com");
    ...
    void getProfile_returnsMappedResponse() {
        ...
        assertThat(emailCaptor.getValue()).isEqualTo("candidate@example.com");
    }
    ...
    void getProfile_withoutEmailThrowsUnauthorized() {
        assertThatThrownBy(() -> candidateProfileService.getProfile("   "))
