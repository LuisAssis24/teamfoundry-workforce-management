...
class EmployeeProfileServiceTest {
    ...
    void getProfile_returnsMappedResponse() {
        ...
        EmployeeProfileResponse response = employeeProfileService.getProfile("Employee@Example.com  ");
    ...
    void updateProfile_updatesAndPersistsEntity() {
        ...
        EmployeeProfileResponse response = employeeProfileService.updateProfile("employee@example.com", request);
    ...
    void getProfile_withoutEmailThrowsUnauthorized() {
        assertThatThrownBy(() -> employeeProfileService.getProfile("   "))
