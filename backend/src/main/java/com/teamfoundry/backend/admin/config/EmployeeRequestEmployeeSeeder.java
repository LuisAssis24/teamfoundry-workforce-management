...
@Configuration
@Profile("!test")
public class EmployeeRequestEmployeeSeeder {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeRequestEmployeeSeeder.class);

    @Bean
    @Order(7)
    CommandLineRunner seedInvites(EmployeeRequestEmployeeRepository inviteRepository,
